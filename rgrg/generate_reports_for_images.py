...
def get_report_for_image(model, image_tensor, tokenizer, bert_score, sentence_tokenizer):
    ...
    beam_search_output, out1, out2, out3 = output

    #print(beam_search_output, out1, out2, out3)
...
def main():
    parser = argparse.ArgumentParser(description='Inference to generate reports')
    parser.add_argument('--images', nargs='+', default=[])

    checkpoint_path = '/Users/viba/Desktop/medvis/rgrg/src/full_model/full_model_checkpoint_val_loss_19.793_overall_steps_155252.pt' 
    #"./src/full_model/full_model_checkpoint_val_loss_19.793_overall_steps_155252.pt"
   ...
   # images_paths = [
#"/home/jphong/rgrg/src/dataset/mimic-cxr-jpg/s54385701/3ea0cd5d-b6ef4a9d-bd053deb-a611067c-284e4144.jpg",
#"/home/jphong/rgrg/src/dataset/mimic-cxr-jpg/s56450978/6b53b66e-2871db03-cfbc3045-4e17bd5b-62902490.jpg",
#"/home/jphong/rgrg/src/dataset/mimic-cxr-jpg/s57532252/60748012-52f2b260-2847eba6-93a13493-3f1196de.jpg"
#"/home/jphong/rgrg/src/dataset/mimic-cxr-jpg/s57532252/5eea2868-4d204411-b9564db0-9681c6a8-5259e13b.jpg"
  #  ]

    args = parser.parse_args()
    cfg = vars(args)
    images_paths = cfg['images']

    generated_reports_txt_path = "./rgrg/results/test_reports_temp.txt"
    generated_reports = []
